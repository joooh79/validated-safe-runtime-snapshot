...
export type { AirtableProviderConfig, RequestExecutor, CreateRequest, UpdateRequest, ExecutorResponse } from './createAirtableProvider.js';

// Types
export type { AirtableTableId, AirtableFieldRef, AirtableAdapterError } from './types.js';

// Mapping registry
export { createDefaultMappingRegistry } from './mappingRegistry.js';
export type { MappingRegistry } from './mappingRegistry.js';
export {
  patientFields,
  patientLinkFields,
  visitFields,
...
export {
  ...
  missingTableMappingError,
  missingFieldMappingError,
  missingOptionMappingError,
  invalidMappedValueError,
  invalidProviderResponseError,
  unsafeWriteBlockedError,
  getErrorMessage,
} from './errors.js';
...
export {
  ...
  normalizeLinkedRef,
  isError,
} from './buildPayload/normalizeAirtableValue.js';

// Fixtures (testing)
export {
  validPatientCreateAction,
  validVisitCreateAction,
  validSnapshotCreateAction,
  unsupportedCaseCreateAction,
  unsupportedSnapshotPlanAction,
  noOpPatientAction,
} from './__fixtures__/exampleActions.js';

 ...
 */
export const successfulExecutionExample: ExecutionResult = {
 ...
 */
export const partialSuccessExecutionExample: ExecutionResult = {
 ...
 */
export const blockedExecutionExample: ExecutionResult = {
 ...
 */
export const noOpExecutionExample: ExecutionResult = {
 ...
 */
export const failedAfterPartialExample: ExecutionResult = {
  ...
  replayEligible: true,
  summary:
    '✗ Execution failed after partial write: 1 succeeded, 1 failed [Warnings: Some actions blocked by upstream failures]',
};
 ...
 */
export const failedBeforeAnyWriteExample: ExecutionResult = {

import type { PatientResolution, VisitResolution, CaseResolution, ResolutionSummary } from '../../types/resolution.js';
 ...
 */
function summarizePatientAction(patient: PatientResolution): string {
 ...
 */
function summarizeVisitAction(visit: VisitResolution): string {
  switch (visit.status) {
 ...
 */
function summarizeNextStep(readiness: ReadinessStatus, interactionMode: InteractionMode): string {

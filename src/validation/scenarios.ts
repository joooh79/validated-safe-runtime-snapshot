...
import type { GoldenCaseInput, GoldenCaseExpectation } from './types.js';
 ...
 */
export const GC_SAFE_NEW_VISIT: GoldenCaseInput = {
...
export const GC_SAFE_NEW_VISIT_EXPECTATION: GoldenCaseExpectation = {
 ...
 */
export const GC_SAME_DATE_UPDATE: GoldenCaseInput = {
...
export const GC_SAME_DATE_UPDATE_EXPECTATION: GoldenCaseExpectation = {
  patientResolutionStatus: 'resolved_existing_patient',
 ...
 */
export const GC_SAME_DATE_CORRECTION_REQUIRED: GoldenCaseInput = {
...
export const GC_SAME_DATE_CORRECTION_REQUIRED_EXPECTATION: GoldenCaseExpectation = {
  patientResolutionStatus: 'resolved_existing_patient',
 ...
 */
export const GC_PATIENT_RECHECK_REQUIRED: GoldenCaseInput = {
...
export const GC_PATIENT_RECHECK_REQUIRED_EXPECTATION: GoldenCaseExpectation = {
 ...
 */
export const GC_DUPLICATE_SUSPICION: GoldenCaseInput = {
...
export const GC_DUPLICATE_SUSPICION_EXPECTATION: GoldenCaseExpectation = {
 ...
 */
export const GC_NEW_PATIENT_AUTO_CASE_CREATE: GoldenCaseInput = {
  id: 'GC_NEW_PATIENT_AUTO_CASE_CREATE',
  title: 'New Patient Auto Case Create',
  description:
    'New patient new visit with continuity none should create patient, visit, case, and snapshots',
  currentStateLookup: {
    patientSearch: {
      found: false,
      patientId: '916872',
...
export const GC_NEW_PATIENT_AUTO_CASE_CREATE_EXPECTATION: GoldenCaseExpectation = {
 ...
 */
export const GC_NEW_PATIENT_AUTO_CASE_MULTI_TOOTH: GoldenCaseInput = {
  id: 'GC_NEW_PATIENT_AUTO_CASE_MULTI_TOOTH',
  title: 'New Patient Auto Case Multi Tooth',
  description:
    'New patient multi-tooth episode should auto-create one case per touched tooth',
  currentStateLookup: {
    patientSearch: {
      found: false,
      patientId: '916873',
...
export const GC_NEW_PATIENT_AUTO_CASE_MULTI_TOOTH_EXPECTATION: GoldenCaseExpectation = {
  patientResolutionStatus: 'create_new_patient',
  visitResolutionStatus: 'create_new_visit',
  caseResolutionStatus: 'create_case',
  readinessStatus: 'ready_for_write_plan',
 ...
 */
export const GC_NEW_PATIENT_FOUND_CONFLICT: GoldenCaseInput = {
  id: 'GC_NEW_PATIENT_FOUND_CONFLICT',
  title: 'New Patient Found Conflict',
  description:
    'New patient workflow must not blindly create a duplicate when lookup finds an existing patient',
  currentStateLookup: {
    patientSearch: {
      found: true,
      patientId: '916874',
...
export const GC_NEW_PATIENT_FOUND_CONFLICT_EXPECTATION: GoldenCaseExpectation = {
  patientResolutionStatus: 'correction_needed_patient_duplicate_suspicion',
  readinessStatus: 'blocked_requires_correction',
  planReadiness: 'blocked',
  shouldExecute: false,
 ...
 */
export const GC_SAFE_CREATE_CASE: GoldenCaseInput = {
  id: 'GC_SAFE_CREATE_CASE',
  title: 'Safe Create Case',
  description:
    'Existing patient, explicit single-tooth create_case request, PRE-only safe slice',
  currentStateLookup: {
    patientSearch: {
      found: true,
      patientId: 'pat_existing_12345',
...
export const GC_SAFE_CREATE_CASE_EXPECTATION: GoldenCaseExpectation = {
  patientResolutionStatus: 'resolved_existing_patient',
  visitResolutionStatus: 'create_new_visit',
  caseResolutionStatus: 'create_case',
  readinessStatus: 'ready_for_write_plan',
 ...
 */
export const GC_SAFE_CONTINUE_CASE: GoldenCaseInput = {
  id: 'GC_SAFE_CONTINUE_CASE',
  title: 'Safe Continue Case',
  description:
    'Existing patient, existing case, later-date PRE continuation with minimal case update',
  currentStateLookup: {
    patientSearch: {
      found: true,
      patientId: 'pat_existing_12345',
...
export const GC_SAFE_CONTINUE_CASE_EXPECTATION: GoldenCaseExpectation = {
  patientResolutionStatus: 'resolved_existing_patient',
  visitResolutionStatus: 'create_new_visit',
 ...
 */
export const GC_SAFE_PLAN_CREATE: GoldenCaseInput = {
  id: 'GC_SAFE_PLAN_CREATE',
  title: 'Safe PLAN Create',
  description:
    'Existing patient, existing case, later-date PLAN snapshot create on the safe single-tooth path',
  currentStateLookup: {
    patientSearch: {
      found: true,
      patientId: 'pat_existing_12345',
...
export const GC_SAFE_PLAN_CREATE_EXPECTATION: GoldenCaseExpectation = {
  patientResolutionStatus: 'resolved_existing_patient',
  visitResolutionStatus: 'create_new_visit',
  caseResolutionStatus: 'continue_case',
  readinessStatus: 'ready_for_write_plan',
 ...
 */
export const GC_SAFE_PLAN_UPDATE: GoldenCaseInput = {
  id: 'GC_SAFE_PLAN_UPDATE',
  title: 'Safe PLAN Update',
  description:
    'Same-date PLAN correction proceeds only when an explicit existing PLAN row target is available',
  currentStateLookup: {
    patientSearch: {
      found: true,
      patientId: 'pat_existing_12345',
...
export const GC_SAFE_PLAN_UPDATE_EXPECTATION: GoldenCaseExpectation = {
  patientResolutionStatus: 'resolved_existing_patient',
  visitResolutionStatus: 'update_existing_visit_same_date',
  caseResolutionStatus: 'none',
  readinessStatus: 'ready_for_write_plan',
 ...
 */
export const GC_SAFE_DR_CREATE: GoldenCaseInput = {
  id: 'GC_SAFE_DR_CREATE',
  title: 'Safe DR Create',
  description:
    'Existing patient, existing case, later-date DR snapshot create on the safe single-tooth path',
  currentStateLookup: {
    patientSearch: {
      found: true,
      patientId: 'pat_existing_12345',
...
export const GC_SAFE_DR_CREATE_EXPECTATION: GoldenCaseExpectation = {
  patientResolutionStatus: 'resolved_existing_patient',
  visitResolutionStatus: 'create_new_visit',
  caseResolutionStatus: 'continue_case',
  readinessStatus: 'ready_for_write_plan',
 ...
 */
export const GC_SAFE_DR_UPDATE: GoldenCaseInput = {
  id: 'GC_SAFE_DR_UPDATE',
  title: 'Safe DR Update',
  description:
    'Same-date DR correction proceeds only when an explicit existing DR row target is available',
  currentStateLookup: {
    patientSearch: {
      found: true,
      patientId: 'pat_existing_12345',
...
export const GC_SAFE_DR_UPDATE_EXPECTATION: GoldenCaseExpectation = {
  patientResolutionStatus: 'resolved_existing_patient',
  visitResolutionStatus: 'update_existing_visit_same_date',
  caseResolutionStatus: 'none',
  readinessStatus: 'ready_for_write_plan',
 ...
 */
export const GC_SAFE_DX_CREATE: GoldenCaseInput = {
  id: 'GC_SAFE_DX_CREATE',
  title: 'Safe DX Create',
  description:
    'Existing patient, existing case, later-date DX snapshot create on the safe single-tooth path',
  currentStateLookup: {
    patientSearch: {
      found: true,
      patientId: 'pat_existing_12345',
...
export const GC_SAFE_DX_CREATE_EXPECTATION: GoldenCaseExpectation = {
  patientResolutionStatus: 'resolved_existing_patient',
  visitResolutionStatus: 'create_new_visit',
  caseResolutionStatus: 'continue_case',
  readinessStatus: 'ready_for_write_plan',
 ...
 */
export const GC_SAFE_DX_UPDATE: GoldenCaseInput = {
  id: 'GC_SAFE_DX_UPDATE',
  title: 'Safe DX Update',
  description:
    'Same-date DX correction proceeds only when an explicit existing DX row target is available',
  currentStateLookup: {
    patientSearch: {
      found: true,
      patientId: 'pat_existing_12345',
...
export const GC_SAFE_DX_UPDATE_EXPECTATION: GoldenCaseExpectation = {
  patientResolutionStatus: 'resolved_existing_patient',
  visitResolutionStatus: 'update_existing_visit_same_date',
  caseResolutionStatus: 'none',
  readinessStatus: 'ready_for_write_plan',
 ...
 */
export const GC_SAFE_RAD_CREATE: GoldenCaseInput = {
  id: 'GC_SAFE_RAD_CREATE',
  title: 'Safe RAD Create',
  description:
    'Existing patient, existing case, later-date RAD snapshot create on the safe single-tooth path',
  currentStateLookup: {
    patientSearch: {
      found: true,
      patientId: 'pat_existing_12345',
...
export const GC_SAFE_RAD_CREATE_EXPECTATION: GoldenCaseExpectation = {
  patientResolutionStatus: 'resolved_existing_patient',
  visitResolutionStatus: 'create_new_visit',
  caseResolutionStatus: 'continue_case',
  readinessStatus: 'ready_for_write_plan',
 ...
 */
export const GC_SAFE_RAD_UPDATE: GoldenCaseInput = {
  id: 'GC_SAFE_RAD_UPDATE',
  title: 'Safe RAD Update',
  description:
    'Same-date RAD correction proceeds only when an explicit existing RAD row target is available',
  currentStateLookup: {
    patientSearch: {
      found: true,
      patientId: 'pat_existing_12345',
...
export const GC_SAFE_RAD_UPDATE_EXPECTATION: GoldenCaseExpectation = {
  patientResolutionStatus: 'resolved_existing_patient',
  visitResolutionStatus: 'update_existing_visit_same_date',
  caseResolutionStatus: 'none',
  readinessStatus: 'ready_for_write_plan',
 ...
 */
export const GC_SAFE_OP_CREATE: GoldenCaseInput = {
  id: 'GC_SAFE_OP_CREATE',
  title: 'Safe OP Create',
  description:
    'Existing patient, existing case, later-date OP snapshot create on the safe single-tooth path',
  currentStateLookup: {
    patientSearch: {
      found: true,
      patientId: 'pat_existing_12345',
...
export const GC_SAFE_OP_CREATE_EXPECTATION: GoldenCaseExpectation = {
  patientResolutionStatus: 'resolved_existing_patient',
  visitResolutionStatus: 'create_new_visit',
  caseResolutionStatus: 'continue_case',
  readinessStatus: 'ready_for_write_plan',
 ...
 */
export const GC_SAFE_OP_UPDATE: GoldenCaseInput = {
  id: 'GC_SAFE_OP_UPDATE',
  title: 'Safe OP Update',
  description:
    'Same-date OP correction proceeds only when an explicit existing OP row target is available',
  currentStateLookup: {
    patientSearch: {
      found: true,
      patientId: 'pat_existing_12345',
...
export const GC_SAFE_OP_UPDATE_EXPECTATION: GoldenCaseExpectation = {
  patientResolutionStatus: 'resolved_existing_patient',
  visitResolutionStatus: 'update_existing_visit_same_date',
  caseResolutionStatus: 'none',
  readinessStatus: 'ready_for_write_plan',
 ...
 */
export const GC_BLOCKED_CASE_AMBIGUITY: GoldenCaseInput = {
  id: 'GC_BLOCKED_CASE_AMBIGUITY',
  title: 'Blocked Case Ambiguity',
  description:
    'Continuation requested but no matching existing case was found; runtime must stay blocked',
  currentStateLookup: {
    patientSearch: {
      found: true,
      patientId: 'pat_existing_12345',
...
export const GC_BLOCKED_CASE_AMBIGUITY_EXPECTATION: GoldenCaseExpectation = {
  patientResolutionStatus: 'resolved_existing_patient',
  visitResolutionStatus: 'create_new_visit',
 ...
 */
export const GC_BLOCKED_PLAN_UPDATE: GoldenCaseInput = {
  id: 'GC_BLOCKED_PLAN_UPDATE',
  title: 'Blocked PLAN Update',
  description:
    'Same-date PLAN correction remains blocked when no explicit existing PLAN row target is available',
  currentStateLookup: {
    patientSearch: {
      found: true,
      patientId: 'pat_existing_12345',
...
export const GC_BLOCKED_PLAN_UPDATE_EXPECTATION: GoldenCaseExpectation = {
  patientResolutionStatus: 'resolved_existing_patient',
  visitResolutionStatus: 'update_existing_visit_same_date',
  caseResolutionStatus: 'none',
  readinessStatus: 'ready_for_write_plan',
 ...
 * Expected: provider adapter blocks honestly before write
 */
export const GC_BLOCKED_DR_UPDATE: GoldenCaseInput = {
  id: 'GC_BLOCKED_DR_UPDATE',
  title: 'Blocked DR Update',
  description:
    'Same-date DR correction remains blocked when no explicit existing DR row target is available',
  currentStateLookup: {
    patientSearch: {
      found: true,
      patientId: 'pat_existing_12345',
...
export const GC_BLOCKED_DR_UPDATE_EXPECTATION: GoldenCaseExpectation = {
  patientResolutionStatus: 'resolved_existing_patient',
  visitResolutionStatus: 'update_existing_visit_same_date',
  caseResolutionStatus: 'none',
  readinessStatus: 'ready_for_write_plan',
 ...
 * Expected: provider adapter blocks honestly before write
 */
export const GC_BLOCKED_DX_UPDATE: GoldenCaseInput = {
  id: 'GC_BLOCKED_DX_UPDATE',
  title: 'Blocked DX Update',
  description:
    'Same-date DX correction remains blocked when no explicit existing DX row target is available',
  currentStateLookup: {
    patientSearch: {
      found: true,
      patientId: 'pat_existing_12345',
...
export const GC_BLOCKED_DX_UPDATE_EXPECTATION: GoldenCaseExpectation = {
  patientResolutionStatus: 'resolved_existing_patient',
  visitResolutionStatus: 'update_existing_visit_same_date',
  caseResolutionStatus: 'none',
  readinessStatus: 'ready_for_write_plan',
 ...
 * Expected: provider adapter blocks honestly before write
 */
export const GC_BLOCKED_RAD_UPDATE: GoldenCaseInput = {
  id: 'GC_BLOCKED_RAD_UPDATE',
  title: 'Blocked RAD Update',
  description:
    'Same-date RAD correction remains blocked when no explicit existing RAD row target is available',
  currentStateLookup: {
    patientSearch: {
      found: true,
      patientId: 'pat_existing_12345',
...
export const GC_BLOCKED_RAD_UPDATE_EXPECTATION: GoldenCaseExpectation = {
  patientResolutionStatus: 'resolved_existing_patient',
  visitResolutionStatus: 'update_existing_visit_same_date',
  caseResolutionStatus: 'none',
  readinessStatus: 'ready_for_write_plan',
 ...
 * Expected: provider adapter blocks honestly before write
 */
export const GC_BLOCKED_OP_UPDATE: GoldenCaseInput = {
  id: 'GC_BLOCKED_OP_UPDATE',
  title: 'Blocked OP Update',
  description:
    'Same-date OP correction remains blocked when no explicit existing OP row target is available',
  currentStateLookup: {
    patientSearch: {
      found: true,
      patientId: 'pat_existing_12345',
...
export const GC_BLOCKED_OP_UPDATE_EXPECTATION: GoldenCaseExpectation = {
  patientResolutionStatus: 'resolved_existing_patient',
  visitResolutionStatus: 'update_existing_visit_same_date',
  caseResolutionStatus: 'none',
  readinessStatus: 'ready_for_write_plan',
 ...
 */
export const GC_BLOCKED_CASE_MAPPING: GoldenCaseInput = {
  id: 'GC_BLOCKED_CASE_MAPPING',
  title: 'Blocked Case Split Mapping',
  description:
    'Scenario triggering split_case; provider adapter must block because split semantics are still intentionally unsupported',
  currentStateLookup: {
    patientSearch: {
      found: true,
      patientId: 'pat_existing_12345',
...
export const GC_BLOCKED_CASE_MAPPING_EXPECTATION: GoldenCaseExpectation = {
  patientResolutionStatus: 'resolved_existing_patient',
  visitResolutionStatus: 'create_new_visit',
 ...
 */
export const GC_NO_OP: GoldenCaseInput = {
  id: 'GC_NO_OP',
...
export const GC_NO_OP_EXPECTATION: GoldenCaseExpectation = {
  patientResolutionStatus: 'resolved_existing_patient',
  visitResolutionStatus: 'update_existing_visit_same_date',
 ...
 */
export const GC_PARTIAL_FAILURE: GoldenCaseInput = {
...
export const GC_PARTIAL_FAILURE_EXPECTATION: GoldenCaseExpectation = {
  patientResolutionStatus: 'resolved_existing_patient',
  visitResolutionStatus: 'create_new_visit',
  planReadiness: 'execution_ready',
  shouldExecute: true,
 ...
 * All scenarios
 */
export const ALL_GOLDEN_CASES: Array<{

...
import {
  fixture_caseContinuation,
  fixture_existingPatientNewVisitSimple,
  fixture_hardStopSameDateKeepNew,
  fixture_patientDuplicateCorrection,
  fixture_patientRecheckRequired,
  fixture_sameDateCorrectionRequired,
} from '../resolution/__fixtures__/scenarioFixtures.js';
...
export function getUiPresets(): UiPresetDefinition[] {
  return [
    {
      ...
      request: createPresetRequest(
        fixture_existingPatientNewVisitSimple.contract,
        fixture_existingPatientNewVisitSimple.lookups,
      ),
    },
    {
      id: 'happy-path-case',
      ...
      request: createPresetRequest(
        fixture_caseContinuation.contract,
        fixture_caseContinuation.lookups,
      ),
    },
    {
      ...
      request: createPresetRequest(
        fixture_sameDateCorrectionRequired.contract,
        fixture_sameDateCorrectionRequired.lookups,
      ),
    },
    {
      id: 'patient-recheck',
      ...
      request: createPresetRequest(
        fixture_patientRecheckRequired.contract,
        fixture_patientRecheckRequired.lookups,
      ),
    },
    {
      ...
      request: createPresetRequest(
        fixture_patientDuplicateCorrection.contract,
        fixture_patientDuplicateCorrection.lookups,
      ),
    },
    {
      id: 'hard-stop',
      ...
      request: createPresetRequest(
        fixture_hardStopSameDateKeepNew.contract,
        fixture_hardStopSameDateKeepNew.lookups,
      ),
    },
  ];
}
...
function createPresetRequest(
  normalizedContract: ApiOrchestrationRequest['normalizedContract'],
  lookupBundle: ApiOrchestrationRequest['lookupBundle'],

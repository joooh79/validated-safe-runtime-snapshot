...
export function buildConversationInteraction(input) {
    ...
    switch (terminalStatus) {
        ...
        case 'no_op':
            return buildInformationalInteraction('no_op', 'No meaningful write was planned.', 'There is nothing to execute for this payload unless it changes materially.', 'no_op');
        case 'executed':
